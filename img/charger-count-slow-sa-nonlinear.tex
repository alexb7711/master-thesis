...
\begin{tikzpicture}
  \begin{axis}[title={Slow Charge Usage},
    ...
    \addplot[gray!80!black, fill=gray, fill opacity=0.05, no markers] table[x=visit, y=slow] {\usagedatasaheuristic};
    \addlegendentry{SA Heuristic}
    \addplot[red!80!black, fill=red, fill opacity=0.25, no markers] table[x=visit, y=slow] {\usagedatamilp};
    \addlegendentry{MILP}
    \addplot[green!80!black, fill=green, fill opacity=0.25, no markers] table[x=visit, y=slow] {\usagedatasanonlinear};
