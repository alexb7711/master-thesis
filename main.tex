...
increase the complexity of the model, as was seen in \ref{sec:milp-pap}. The chapter aims to expand on the MILP by
...
model. The non-linear model will be employed the SA algorithm derived in \ref{sec:sa-pap} The chapter proceeds as follows: an
introduction to the non-linear battery dynamics model is shown in \ref{sec:nonlinear-model} along with a proof and
description of how the model is incorporated. \ref{sec:nonlinear-results} presents and discusses the results.
