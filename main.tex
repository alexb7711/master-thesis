...
\date{}
\title{A Position Allocation Problem Approach To The Battery Electric Bus Charging Problem Utilizing Mixed Integer Linear Programming And Simulated Annealing Techniques With Linear And Non-Linear Battery Charging Dynamics}
\begin{document}
