...
Previous work shows that there has been previous work that utilized a stochastic approach \cite{bie-2021-optim-elect,duan-2021-refor-mixed,tang-2019-robus-sched}. Work related to the BAP shows a Fully Fuzzy Linear Program (FFLP)
implementation that utilized the Nasseri Method in converting the FFLP to its ``crisp'' counterpart
