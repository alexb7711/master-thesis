...
An example for the MILP PAP formulation was presented in \ref{sec:milp-pap} and compared to a heuristic-based schedule,
...
day. The qin-modified schedule, on the other hand, allowed the SOC of certain BEBs to drop to 0$\backslash$%.
