...
\(\epsilon_q\) & Cost of using charger \(q\) per unit time & \(\Upsilon\) & \(\Upsilon: \mathbb{V} \rightarrow \mathbb{V}\) mapping a visit to the next visit by the same bus w\(\Upsilon_i\) being the shorthand.\\[0pt]
...
\begin{tabular}{|l|cccc|}
\hline
 & MILP & Non-Linear & Heuristic & Quick\\[0pt]
\hline
Mean & 179.580229533742 & 293.913456149408 & 189.525113828846 & 216.523166855178\\[0pt]
Min & 96.9999999999463 & 57.84468 & 6.3432083 & 29.862568\\[0pt]
\hline
\end{tabular}
\end{table}
