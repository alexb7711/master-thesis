...
\section{\textbf{Objective 2}: Mathematically model non-linear battery dynamics to increase the accuracy of the SOC estimate}
...
\chapter{Method And Validation}
\label{sec:org03855fc}
