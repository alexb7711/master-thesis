...
\label{sec:orgc65bdda}
The following Gantt chart, shown in \autoref{fig:gantt}, plots out the work that has been completed and the work to be
completed. The estimated completion date is med to late-November. Note that the blocks before the \texttt{TODAY} mark in
