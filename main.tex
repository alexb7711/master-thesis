...
example solution is visualized in \ref{img:baprep}. The x and y-axis represent time and berthing space, respectively. The
...
\cite{liu-2020-batter-elect}, non-linear battery dynamics can be implemented to increase the accuracy of the model's
...
dynamics can be modeled as a piecewise function containing a linear and non-linear components. Others have modeled the
