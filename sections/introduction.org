...
The intent of the proposed work is to construct an optimal model to create an optimal charging schedule for a fleet of
BEBs by build upon what is known as the Position Allocation Problem [cite:@qarebagh-2019-optim-sched]. The PAP is a
modification of the well studied Berth Allocation Problem (BAP)

#+begin_comment
, as a means to schedule the charging of electric
