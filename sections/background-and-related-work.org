...
# +include: ../sup-doc/sa-pap-paper/sections/introduction.org::#sec:sa-introduction :only-contents t
...
#+include: "../sup-doc/fuzzy-lp-paper/sections/preliminaries.org::*Mixed Integer Linear Program" :lines "2-24"
