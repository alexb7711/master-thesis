...
#+caption: Plot of the linear and non-linear charge charge profiles. Note the intersections at the 80% SOC line indicated by the horizontal red dashed line.
