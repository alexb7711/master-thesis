* SIMULATED ANNEALING WITH LINEAR BATTERY DYNAMICS
:PROPERTIES:
...
The remainder of this chapter goes as follows. [[#sec:sa-problem-description]] provides the problem statement associated with
